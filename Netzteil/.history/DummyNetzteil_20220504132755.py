...
import os
from DCNetzteilInterface.Netzteil.NetzteilStatus.NetzteilStatus import NetzteilStatus
from DCNetzteilInterface.Netzteil.NetzteilStatus.Off import Off
from NetzteilAutomation.NetzteilAutomation import NetzteilAutomation
...
class DummyNetzteil(DCNetzteilInterface):
    ...
    def set_status(self,status:NetzteilStatus):
        if (status.__class.__.__name__ != self.__status.__class.__name__):
